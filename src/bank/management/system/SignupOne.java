...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        formno.setFont(new Font("Verdana", Font.BOLD, 35));
        formno.setBounds(140, 20, 600, 40);
        add(formno);
        
        JLabel personalDetails =  new JLabel("Page 1: Personal Details");
        personalDetails.setFont(new Font("Calibri", Font.BOLD, 22));
        ...
        male.setBackground(Color.decode("#F0FFF2"));
        add(male);
        
        female = new JRadioButton("Female");
        female.setBounds(450, 290, 120, 30);
        female.setBackground(Color.decode("#F0FFF2"));
        add(female);
        ...
        marital.setFont(new Font("Calibri", Font.BOLD, 20));
        marital.setBounds(100, 390, 200, 30);
        add(marital);
        
        married = new JRadioButton("Married");
        married.setBounds(300, 390, 100, 30);
        married.setBackground(Color.decode("#F0FFF2"));
        add(married);
        
        unmarried = new JRadioButton("Unmarried");
        unmarried.setBounds(450, 390, 100, 30);
        unmarried.setBackground(Color.decode("#F0FFF2"));
        add(unmarried);
        
        other= new JRadioButton("Other");
        other.setBounds(630, 390, 100, 30);
        other.setBackground(Color.decode("#F0FFF2"));
        add(other);
        
        ButtonGroup margrp = new ButtonGroup();
        margrp.add(married);
        margrp.add(unmarried);
        margrp.add(other);
